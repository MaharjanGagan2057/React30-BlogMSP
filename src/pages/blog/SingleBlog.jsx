    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row -mx-4">
            ...
            <div class="md:flex-1 px-4">
                ...
                <div class="flex mb-4">
                    <div class="mr-4">
                        <span class="font-bold text-gray-700 dark:text-gray-300">Catagory:</span>
                        <span class="text-gray-600 dark:text-gray-300"> Finance</span>
                    </div>
                    <div>
                        <span class="font-bold text-gray-700 dark:text-gray-300">Publish At:</span>
                        <span class="text-gray-600 dark:text-gray-300"> 1990/07/23</span>
                    </div>
                </div>
